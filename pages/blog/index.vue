    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-4xl">
        ...
        <p class="mt-2 text-lg/8 text-gray-700">
          Welcome to the Notebook. This one will contain highlights of work
          done, blog posts and write-ups about anything from silence to my
          love/hate relationship with SpringBoot, to my thoughts on Doechii
          winning a grammy and everything in between.
        </p>
