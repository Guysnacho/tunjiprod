<template>
    ...
    <div class="space-y-5 w-5/6 mx-auto">
        <blockquote class="relative">
            <svg class="absolute self-center -left-[5vw] sm:left-[10vw] md:left-[17vw] lg:left-[23vw] -top-[4vh] size-16 text-gray-100 dark:text-neutral-700 opacity-40 text-center"
            ...
            <div class="relative z-10 text-center">
                <p class="text-gray-800 sm:text-xl text-center"><em>
                        I want anything I build and project I work on to
                    </em></p>
            </div>
        </blockquote>
