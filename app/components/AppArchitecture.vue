...
const architectureFeatures = [
  {
    ...
    description:
      'Isolated environments for each conference ensure data privacy and performance stability.',
    color: 'emerald'
  },
  {
...
<template>
  <section id="architecture" class="py-24 bg-stone-900 text-stone-50 overflow-hidden">
    <UContainer>
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div class="animate-fade-in-left">
          <UBadge color="warning" variant="subtle" size="md" class="mb-3">
            SYSTEM ARCHITECTURE
          </UBadge>
          <h3 class="text-3xl md:text-5xl font-bold mb-8 text-stone-100">
            Robust Multi-Tenant Backbone
          </h3>
          <p class="text-stone-400 text-lg mb-10 leading-relaxed">
            Our infrastructure is built for reliability and scale, using a sophisticated
            multi-domain architecture that keeps data secure while maintaining high availability.
          </p>
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <div>
                <h4 class="text-xl font-bold mb-1 text-stone-200">
                  {{ feature.title }}
                </h4>
        ...
        <div class="relative animate-scale-in">
          ...
          >
            ...
            <div class="mt-4 grid grid-cols-2 gap-4">
              ...
              >
                <p class="text-xs text-stone-400 uppercase mb-1 font-bold">
                  {{ stat.label }}
                </p>
                <p
