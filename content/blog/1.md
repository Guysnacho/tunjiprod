...
---
items:
  - blurb: Why'd you chose green for the project cards?
  - blurb: You do know the logo isn't centered right? Because everyone else knows…. yeeaaah just keep scrolling.
  - blurb: Do I need a whole db for just this? Supabase isn't free my boy.
...
[You can check out version 1 here](https://release-test--tunjiprod.netlify.app/){.underline.hover:no-underline.text-green-700.hover:text-green-400} but the long and short of it is the project that I was so proud of initially didn't grow with me. 

::StringList
---
items:
  - blurb: The tooling and admin page that I scaffolded didn't serve any purpose now that I built TwoTone
  - 
    blurb: There are some gems that I'll keep forever but those weren't cool enough to outshine the things that irked me
    sublist:
      - Inspo card
      - Hand-drawn everything
  - blurb: I knew I could do much better now with my current toolbox
---
::
...
Whenever I start a new project the goal is to learn and/or do something cool and this wouldn't be an exception. [Funilly enough that rule came from this project in 2023 using the exact same framework I rewrote it with](https://github.com/Guysnacho/tunjiprod/commit/c3fd93eac251e1f9067e3e23485481c87a115b0a){.underline.hover:no-underline.text-green-700.hover:text-green-400}. This time the site needed to serve a purpose and look good while doing it.