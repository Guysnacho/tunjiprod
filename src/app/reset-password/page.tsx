...
import { z } from 'zod'
import { ShieldCheck, KeyRound, Check, CheckCircle2, ArrowLeft, ArrowRight } from 'lucide-react'
              ...
              <>
                <div className="text-center mb-8">
                  <div className="w-14 h-14 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                    <ShieldCheck className="w-7 h-7 text-emerald-800 dark:text-emerald-400" />
                  </div>
