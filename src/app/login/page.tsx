...
import { z } from 'zod'
import { Lock, Mail, KeyRound, ArrowRight, Send, MailCheck } from 'lucide-react'
          ...
          <CardContent className="p-8 sm:p-10">
            ...
            <div className="text-center mb-8">
              <div className="w-14 h-14 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <Lock className="w-7 h-7 text-emerald-800 dark:text-emerald-400" />
              </div>
              <h1 className="text-2xl font-bold text-stone-900 dark:text-stone-50">Welcome back</h1>
              <p className="text-stone-600 dark:text-stone-400 mt-1">Sign in to your account</p>
            </div>
                      ...
                      <FormItem>
                        <div className="flex items-center justify-between">
                          ...
                          <Link
                            ...
                            className="text-xs font-medium text-emerald-700 dark:text-emerald-400 hover:text-emerald-900 dark:hover:text-emerald-300"
                          >
                            Forgot password?
                          </Link>
                        </div>
